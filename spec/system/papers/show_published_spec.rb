...
feature "Published paper's show page" do
  before do
    @accepted_paper = create(:accepted_paper, title: "Astronomy paper", doi: "10.21105/resciencec.00001", review_issue_id: 1)
    ...
    @retracted_paper = create(:retracted_paper, title: "Bad paper", doi: "10.21105/resciencec.00002", review_issue_id: 2)
    @retracted_paper.metadata['paper']['title'] = "Bad paper"
    @retracted_paper.save!

    @retraction_notice = create(:accepted_paper, title: "Retraction notice for: Bad paper", doi: "10.21105/resciencec.00002R")
